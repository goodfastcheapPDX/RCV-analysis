...
import { electionIdFrom, contestIdFrom } from "../src/contracts/ids";
...
async function main() {
  try {
    ...
    const srcCsv = srcCsvArg || process.env.SRC_CSV || "data/2024-11/canonical/district-2-cast-vote-record.csv";
