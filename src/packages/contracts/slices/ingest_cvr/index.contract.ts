...
export const SQL_QUERIES = {
  ...
  exportCandidates: (outputPath: string) => `COPY candidates_with_identity TO '${outputPath}/candidates.parquet' (FORMAT 'parquet');`,

  exportBallotsLong: (outputPath: string) => `COPY ballots_long_with_identity TO '${outputPath}/ballots_long.parquet' (FORMAT 'parquet');`,
} as const;
