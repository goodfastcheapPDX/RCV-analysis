...
import { CandidateAffinityMatrixView } from "@/contracts/slices/candidate_affinity_matrix/view";
  ...
  try {
    ...
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">Candidate Affinity Matrix</h1>
      ...
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">
            Candidate Affinity Matrix Not Available
          </h1>
          <p className="text-muted-foreground mt-2">
            Candidate affinity matrix data for this contest could not be loaded.
          </p>
        </div>
